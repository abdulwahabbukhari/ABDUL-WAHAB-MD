/**
   * Create By 𝑺𝒚𝒆𝒅 𝑨𝒃𝒅𝒖𝒍 𝒘𝒂𝒉𝒂𝒃 𝒃𝒖𝒌𝒉𝒂𝒓𝒊 OFFICIAL
   * Contact Me on 923376539373
*/
...
const initializeBot = async () => {
    ...
    console.log(chalk.green('   𝑺𝒚𝒆𝒅 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting 𝑺𝒚𝒆𝒅 MD system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅𝑺𝒚𝒆𝒅 MD bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅𝑺𝒚𝒆𝒅 тɛℓɛɢяαм вσт: Active') : chalk.red('❌𝑺𝒚𝒆𝒅 тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ 𝑺𝒚𝒆𝒅 system is ready and running!\n'));
    }
